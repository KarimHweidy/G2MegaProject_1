...
uint8_t DMA_u8Init(const DMA_Config_t* ARG_pDMAconfig)
{
	uint8_t Local_u8ErrorState=OK;
	if(ARG_pDMAconfig == NULL)
	{
...
void DMA_voidClearInterruptFlag(DMA_Num_t ARG_u8DMANumber, DMA_Stream_t ARG_u8StreamNumber, DMA_Flag_t ARG_u8Flag)
{
	...
	uint8_t Local_u8RegNum = (ARG_u8StreamNumber) / 2;  // u16_arr[4]  -->  0 2 3 4 5  
	uint8_t Local_u8BitNum = ( (ARG_u8StreamNumber % 2 )*6) + ARG_u8Flag ;  // 6 or 0 + f ,,, u16_arr[4]  -->  0 2 3 4 5 
...
void DMA_voidStartTransfer(const DMA_Config_t *ARG_pDMAconfig, uint32_t ARG_u32SourceAddress, uint32_t ARG_u32DestinationAddress, uint16_t ARG_u16DataLength)
{
...
void DMA_voidStartTransferIT(DMA_Config_t *ARG_pDMAconfig, uint32_t ARG_u32SourceAddress, uint32_t ARG_u32DestinationAddress, uint16_t ARG_u16DataLength)
{
	if (ARG_pDMAconfig->DataDirection == MEMORY_TO_MEMORY || ARG_pDMAconfig->DataDirection == PERIPHERAL_TO_MEMORY)
	{
		/* Setting Source Address */
...
uint8_t DMA_u8CheckingInterruptFlagSource(DMA_Num_t ARG_DMANumber, DMA_Stream_t ARG_StreamNumber, DMA_Flag_t ARG_u8Flag)
{
	uint8_t Local_u8FlagSource = 0;
	/* Local Variable To Hold Register Number */
	uint8_t Local_u8RegNum = (ARG_StreamNumber) / 2;  // u16_arr[4]  -->  0 2 3 4 5  
	uint8_t Local_u8BitNum = ( (ARG_StreamNumber)*6) + ARG_u8Flag ;  // 6 or 0 + f ,,, u16_arr[4]  -->  0 2 3 4 5  
...
void DMA1_Stream1_IRQHandler(void)
{
	/* Checking Interrupt Flag Source*/
	/* Transfer Complete */
	if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_1, TCIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_1, TCIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_1][TCIF]();
	}
	/* Half Transfer Complete */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_1, HTIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_1, HTIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_1][HTIF]();
	}
	/* Transfer Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_1, TEIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_1, TEIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_1][TEIF]();
	}
	/* FIFO Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_1, FIEF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_1, FIEF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_1][FIEF]();
	}
	/* Direct Mode Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_1, DMEIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_1, DMEIF);
		/* Calling Callback Function */
...
void DMA1_Stream2_IRQHandler(void)
{
	/* Checking Interrupt Flag Source*/
	/* Transfer Complete */
	if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_2, TCIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_2, TCIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_2][TCIF]();
	}
	/* Half Transfer Complete */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_2, HTIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_2, HTIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_2][HTIF]();
	}
	/* Transfer Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_2, TEIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_2, TEIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_2][TEIF]();
	}
	/* FIFO Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_2, FIEF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_2, FIEF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_2][FIEF]();
	}
	/* Direct Mode Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_2, DMEIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_2, DMEIF);
		/* Calling Callback Function */
...
void DMA1_Stream3_IRQHandler(void)
{
	/* Checking Interrupt Flag Source*/
	/* Transfer Complete */
	if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_3, TCIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_3, TCIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_3][TCIF]();
	}
	/* Half Transfer Complete */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_3, HTIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_3, HTIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_3][HTIF]();
	}
	/* Transfer Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_3, TEIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_3, TEIF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_3][TEIF]();
	}
	/* FIFO Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_3, FIEF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_3, FIEF);
		/* Calling Callback Function */
		DMA1_PTR[DMA_STREAM_3][FIEF]();
	}
	/* Direct Mode Error */
	else if (DMA_u8CheckingInterruptFlagSource(DMA_1, DMA_STREAM_3, DMEIF))
	{
		/* Clearing Interrupt Flag */
		DMA_voidClearInterruptFlag(DMA_1, DMA_STREAM_3, DMEIF);
		/* Calling Callback Function */
