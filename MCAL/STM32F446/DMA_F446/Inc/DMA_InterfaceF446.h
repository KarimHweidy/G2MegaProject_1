...
typedef struct
{
    uint8_t TransferCompleteInterrupt; // Transfer Complete Interrupt --> ON or OFF
    uint8_t HalfTransferInterrupt;     // Half Transfer Interrupt     --> ON or OFF
    uint8_t TransferErrorInterrupt;    // Transfer Error Interrupt    --> ON or OFF
    uint8_t DirectModeErrorInterrupt;  // Direct Mode Error Interrupt --> ON or OFF
    //uint8_t FIFOErrorInterrupt;        // FIFO Error Interrupt        --> ON or OFF
